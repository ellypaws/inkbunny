...
func (u *User) DeleteFile(id int) (DeleteFileResponse, error) {
	if u.SID == "" {
		return DeleteFileResponse{FileID: types.IntString(id)}, ErrEmptySID
	}
...
func (u *User) ReorderFile(id int, position int) (ReorderFileResponse, error) {
	if u.SID == "" {
		return ReorderFileResponse{FileID: types.IntString(id), NewPosition: types.IntString(position)}, ErrEmptySID
	}
